...
exports.editor = function (color) {
    return {
        ...
        'editorLightBulbAutoFix.foreground': color.yellow,
        ...
        'editorOverviewRuler.deletedForeground': alpha(color.red, .6),
        'editorOverviewRuler.errorForeground': color.red,
        'editorOverviewRuler.warningForeground': color.yellow,
        ...
        'editorHint.foreground': color.blue,
        //   'editorHint.border': color.red,
